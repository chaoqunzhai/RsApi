...
INSERT INTO `sys_role` (`role_id`, `role_name`, `status`, `role_key`, `role_sort`, `flag`, `remark`, `admin`, `data_scope`, `create_by`, `update_by`, `created_at`, `updated_at`, `deleted_at`) VALUES (1, 'admin', '2', 'admin', 1, '', '', 1, '', 1, 1, '2021-05-13 19:56:37.913', '2021-05-13 19:56:37.913', NULL);
INSERT INTO `sys_role` (`role_id`, `role_name`, `status`, `role_key`, `role_sort`, `flag`, `remark`, `admin`, `data_scope`, `create_by`, `update_by`, `created_at`, `updated_at`, `deleted_at`) VALUES (2, 'super', '2', 'super', 0, '', '', 0, '', 0, 0, '2024-07-25 17:31:32.936', '2024-07-25 17:31:32.936', NULL);
INSERT INTO `sys_role` (`role_id`, `role_name`, `status`, `role_key`, `role_sort`, `flag`, `remark`, `admin`, `data_scope`, `create_by`, `update_by`, `created_at`, `updated_at`, `deleted_at`) VALUES (3, 'sre', '2', 'sre', 0, '', '', 0, '1', 0, 0, '2024-08-12 15:02:26.965', '2024-08-12 15:08:01.020', NULL);
INSERT INTO `sys_role` (`role_id`, `role_name`, `status`, `role_key`, `role_sort`, `flag`, `remark`, `admin`, `data_scope`, `create_by`, `update_by`, `created_at`, `updated_at`, `deleted_at`) VALUES (4, 'company_user', '2', 'company_user', 0, '', '公司用户角色', 0, '', 0, 0, '2024-08-14 11:51:45.478', '2024-08-14 11:53:55.725', NULL);
INSERT INTO `sys_role` (`role_id`, `role_name`, `status`, `role_key`, `role_sort`, `flag`, `remark`, `admin`, `data_scope`, `create_by`, `update_by`, `created_at`, `updated_at`, `deleted_at`) VALUES (5, 'business_user', '2', 'business', 0, '', '商务角色', 0, '', 0, 0, '2024-08-14 11:52:13.507', '2024-08-14 11:53:44.621', NULL);
INSERT INTO `sys_role` (`role_id`, `role_name`, `status`, `role_key`, `role_sort`, `flag`, `remark`, `admin`, `data_scope`, `create_by`, `update_by`, `created_at`, `updated_at`, `deleted_at`) VALUES (6, 'liaison_user', '2', 'liaison_user', 0, '', '联系人角色', 0, '', 0, 0, '2024-08-14 11:52:59.481', '2024-08-14 11:53:38.674', NULL);
INSERT INTO `sys_role` (`role_id`, `role_name`, `status`, `role_key`, `role_sort`, `flag`, `remark`, `admin`, `data_scope`, `create_by`, `update_by`, `created_at`, `updated_at`, `deleted_at`) VALUES (7, 'signatory_user', '2', 'signatory_user', 0, '', '签订角色', 0, '', 0, 0, '2024-08-14 11:53:28.730', '2024-08-14 11:53:28.730', NULL);
INSERT INTO `sys_role` (`role_id`, `role_name`, `status`, `role_key`, `role_sort`, `flag`, `remark`, `admin`, `data_scope`, `create_by`, `update_by`, `created_at`, `updated_at`, `deleted_at`) VALUES (8, 'operate_user', '2', 'operate_user', 0, '', '运营角色', 0, '', 0, 0, '2024-08-14 11:57:04.695', '2024-08-14 11:57:04.695', NULL);

INSERT INTO sys_user VALUES (1, 'admin', '$2a$10$/Glr4g9Svr6O0kvjsRJCXu3f0W8/dsP3XZyVNi1019ratWpSPMyw.', 'sre', '13818888888', 1, '', '', '1', '1@qq.com', 1, 1, '', '2', 1, 1, '2021-05-13 19:56:37.914', '2021-05-13 19:56:40.205', NULL);
-- 数据完成 ;