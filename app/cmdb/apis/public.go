...
// GetPage
// @Summary 城市数据
// @Description 获取JSON Tree
// @Tags 公共接口
// @Success 200 {object} response.Response "{"code": 200, "data": [...]}"
// @Router /api/v1/public/city_tree [get]
// @Security Bearer

func (e *Public) CityTree(c *gin.Context) {
	s := service.PublicApi{}
	err := e.MakeContext(c).
		MakeOrm().
	...
	result, _ := s.GetTreeData(0, cacheChildren, lists)
	e.OK(result, "")
	return
}
...
// @Security Bearer
func (e *Public) UploadFile(c *gin.Context) {
	e.MakeContext(c)
...
func (e *Public) baseImg(c *gin.Context, fileResponse FileResponse, urlPerfix string) FileResponse {
...
func (e *Public) multipleFile(c *gin.Context, urlPerfix string) []FileResponse {
...
func (e *Public) singleFile(c *gin.Context, fileResponse FileResponse, urlPerfix string) (FileResponse, bool) {
