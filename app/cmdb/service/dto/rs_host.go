...
type RsHostGetPageReq struct {
    ...
    Operator string `form:"operator"  search:"type:exact;column:operator;table:rs_host" comment:"运营商"`
...
type RsHostOrder struct {
    ...
    BusinessSn string `form:"businessSnOrder"  search:"type:order;column:business_sn;table:rs_host"`
    Province string `form:"provinceOrder"  search:"type:order;column:province;table:rs_host"`
    City string `form:"cityOrder"  search:"type:order;column:city;table:rs_host"`
...
type RsHostInsertReq struct {
    ...
    Memory string `json:"memory" comment:"总内存"`
    Disk string `json:"disk" comment:"总磁盘"`
    Kernel string `json:"kernel" comment:"内核版本"`
    Belong string `json:"belong" comment:"机器归属"`
    Remark string `json:"remark" comment:"备注"`
    Operator string `json:"operator" comment:"运营商"`
    Status string `json:"status" comment:"主机状态"`
    NetDevice string `json:"netDevice" comment:"网卡信息"`
    Balance string `json:"balance" comment:"总带宽"`
    BusinessSn string `json:"businessSn" comment:"业务SN"`
    Province string `json:"province" comment:"省份"`
    City string `json:"city" comment:"城市"`
    Isp string `json:"isp" comment:"运营商"`
    common.ControlBy
}
