...
type RsContract struct {
	...
	BuId           int                    `json:"-" gorm:"type:bigint;comment:商务人员"`
	CustomId       int                    `json:"-" gorm:"type:bigint;comment:所属客户ID"`
	SignatoryId    int                    `json:"-" gorm:"type:bigint;comment:签订人"`
...
func (e *RsContract) AfterFind(tx *gorm.DB) (err error) {
	...
	e.BuInfo = map[string]interface{}{
		"username": "",
	}
	e.CustomInfo = map[string]interface{}{
		"username": "",
	}
	e.SignatoryInfo = map[string]interface{}{
		"username": "",
	}
	return nil
}
